...
def setup(config):
    ...
    with open(definitions_path, 'w') as f:
        ...
        yaml.safe_dump(config['repositories'], f)
    ...
    ### keys
    os.remove(os.path.join(CODE, "keys", "piloteur-admin"))
    os.remove(os.path.join(CODE, "keys", "piloteur-admin") + '.pub')
    os.remove(os.path.join(CODE, "keys", "piloteur-devices"))
    os.remove(os.path.join(CODE, "keys", "piloteur-devices") + '.pub')
